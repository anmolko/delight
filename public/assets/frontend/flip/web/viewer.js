...
'use strict';
var brocher = $('#brocher-id').val().trim();

var DEFAULT_URL = 'assets/frontend/brocher/' + brocher;
...
PDFJS.workerSrc = 'assets/frontend/flip/build/pdf.worker.js';
PDFJS.cMapUrl = 'assets/frontend/flip/web/cmaps/';
