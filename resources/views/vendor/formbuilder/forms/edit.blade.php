        ...
        <div class="col-md-12">
            <div class="card">
                    ...
                    <h5 class="card-title">
                        ...
                        <div class="btn-toolbar float-md-right" role="toolbar">
                            <div class="btn-group" role="group">
                                <a href="{{ route('formbuilder::forms.index') }}" class="btn btn-sm btn-theme text-white ctm-border-radius button-1 float-md-right">
                                    <i class="fa fa-arrow-left"></i> Back To My Forms
                                </a>
                                <button class="btn btn-theme text-white ctm-border-radius button-1 btn-sm clipboard" data-clipboard-text="{{ route('formbuilder::form.render', $form->identifier) }}" data-message="Link Copied" data-original="Copy Form Link" title="Copy form URL to clipboard">
                ...
                <div class="card-footer" id="fb-editor-footer" style="display: none;">
                    <button type="button" class="btn btn-theme text-white ctm-border-radius button-1 fb-clear-btn">
                        <i class="fa fa-remove"></i> Clear Form 
                    </button> 
                    <button type="button" class="btn btn-theme text-white ctm-border-radius button-1 fb-save-btn">
