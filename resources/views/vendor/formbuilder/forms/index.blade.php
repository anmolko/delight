                        ...
                        <h5 class="card-title">
                            ...
                            <div class="btn-toolbar float-md-right" role="toolbar">
                                <div class="btn-group" role="group" aria-label="Third group">
                                    <a href="{{ route('formbuilder::forms.create') }}" class="btn btn-theme text-white ctm-border-radius button-1 btn-sm">
                                        <i class="fa fa-plus-circle"></i> Create a New Form
                                    </a>

                                    <a href="{{ route('formbuilder::my-submissions.index') }}" class="btn btn-theme text-white ctm-border-radius button-1 btn-sm">
