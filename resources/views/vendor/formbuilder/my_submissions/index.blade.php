            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        <a href="{{ route('formbuilder::forms.index') }}" class="btn btn-theme text-white ctm-border-radius button-1 float-md-right btn-sm" title="Back To My Forms">
                            ...
                            <tbody>
                                @foreach($submissions as $submission)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('formbuilder::my-submissions.show', [$submission->id]) }}" class="btn btn-theme text-white ctm-border-radius button-1 btn-sm" title="View submission">
                                                <i class="fa fa-eye"></i> View
                                            </a> 

                                            @if($submission->form->allowsEdit())
                                                <a href="{{ route('formbuilder::my-submissions.edit', [$submission->id]) }}" class="btn btn-theme text-white ctm-border-radius button-1 btn-sm" title="Edit submission">
