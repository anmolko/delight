                    ...
                    <div class="card-body">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-9 mb-4">
                                ...
                                <span class="ctm-text-sm">*use image minimum of 270 x 300px for Team</span>
                            </div>
                        </div>
                                        ...
                                        @if(@$teams)
                                            @foreach($teams as  $team)
                                                ...
                                                <td class="pl-3"><i class="fa fa-sort"></i></td>
                                                    ...
                                                    <td>
                                                        @if($team->fb == null && $team->twitter == null && $team->insta == null & $team->linkedin == null)
                                                            Not Set
                                                        @endif

                                                        @if($team->fb !== null)
                                                            fb: <a href="{{@$team->fb}}" target="_blank">{{@$team->fb}}</a>
                                                        @endif
                                                        @if($team->twitter !== null)
                                                            <br>twitter: <a href="{{@$team->twitter}}" target="_blank">{{@$team->twitter}}</a>
                                                        @endif
                                                        @if($team->insta !== null)
                                                            <br>insta: <a href="{{@$team->insta}}" target="_blank">{{@$team->insta}}</a>
                                                        @endif
                                                        @if($team->linkedin !== null)
                                                            <br>linkedIn: <a href="{{@$team->linkedin}}" target="_blank">{{@$team->linkedin}}</a>
                                                        @endif
