                                                    ...
                                                    <td class="align-middle pt-6 pb-4 px-6">
                                                        <div class="avatar-upload">
                                                            <div class="blog-preview">
                                                                <img id="blog-img" src="{{asset('/images/uploads/sliders/'.$slider->slider_front_image)}}" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>{{$slider->heading}}</td>
                                                    <td>{{$slider->subheading_one}}</td>
                                                    <td>{{$slider->button_one}}</td>
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <div class="col-8 mb-4">
                                            <div class="custom-file h-auto">
                                                <div class="avatar-upload">
                                                    <div class="avatar-edit">
                                                        <input type="file" class="custom-file-input" hidden id="image" onchange="loadbasicFile('image','current-img',event)" name="slider_front_image" required>
                                            ...
                                            <span class="ctm-text-sm">*use image minimum of 1920 x 400px for slider front</span>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card ctm-border-radius shadow-sm flex-fill">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Button title <span class="text-muted text-danger">*</span></label>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-9 mb-4">
                                            <div class="custom-file h-auto">
                                                <div class="avatar-upload">
                                                    <div class="avatar-edit">
                                                        <input type="file" class="custom-file-input" hidden id="image-edit" onchange="loadbasicFile('image-edit','current-edit-img',event)" name="slider_front_image">
