                            ...
                            <div class="card-body">
                                <div class="row no-gutters">
                                    ...
                                    <div class="col-6 align-items-center shadow-none text-center">
                                        <a href="{{route('pages.index')}}" class="{{(Request::segment(2) == 'pages' || Request::segment(2) == 'section-elements' ) ? "text-white active":"text-dark"}} p-4 ctm-border-right ctm-border-left"><span class="lnr lnr-file-empty pr-0 pb-lg-2 font-23"></span><span class="">Pages</span></a>
                                    </div>
                                    <div class="col-6 align-items-center shadow-none text-center">
                                    ...
                                    <div class="col-6 align-items-center shadow-none text-center">
                                        <a id="service-cat" href="{{route('service-category.index')}}" class="{{(Request::segment(2) == 'service-category') ? "text-white active":"text-dark"}} p-4 ctm-border-right" data-original-title="Service Category"><span class="lnr lnr-tag pr-0 pb-lg-2 font-23"></span><span class="">Category</span></a>
                                    </div>
                                    <div class="col-6 align-items-center shadow-none text-center">
                                    ...
                                    <div class="col-6 align-items-center shadow-none text-center">
                                        <a href="{{route('album.index')}}" class="{{(Request::segment(2) == 'album') ? "text-white active":"text-dark"}} p-4 ctm-border-right ctm-border-left"><span class="lnr lnr-camera pr-0 pb-lg-2 font-23"></span><span class="">Album</span></a>
                                    </div>
                                    <div class="col-6 align-items-center shadow-none text-center">
                                        <a href="{{route('career.index')}}" class="{{(Request::segment(2) == 'career') ? "text-white active":"text-dark"}} p-4 ctm-border-right"><span class="lnr lnr-book pr-0 pb-lg-2 font-23"></span><span class="">Career</span></a>
                                    </div>
                                    <div class="col-6 align-items-center shadow-none text-center">
                                    ...
                                    <div class="col-6 align-items-center shadow-none text-center">
                                            <a href="{{route('press-release.index')}}" class="{{(Request::segment(2) == 'press-release') ? "text-white active":"text-dark"}} p-4 last-slider-btn1 ctm-border-right ctm-border-left"><span class="lnr lnr-bullhorn pr-0 pb-lg-2 font-23"></span><span class="">Press</span></a>
                                    </div>
                                    <div class="col-6 align-items-center shadow-none text-center">
                                        <a href="{{route('setting.index')}}" class="{{(Request::segment(2) == 'settings') ? "text-white active":"text-dark"}} p-4 last-slider-btn ctm-border-right"><span class="lnr lnr-cog pr-0 pb-lg-2 font-23"></span><span class="">Settings</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
